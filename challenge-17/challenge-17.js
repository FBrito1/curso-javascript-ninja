(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, "Fabio Brito"))
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, "caiçara"))
  ...
  */
  ...
  const regexDate = /(\d\d) de (julho|junho) de (\d\d\d\d)/g
